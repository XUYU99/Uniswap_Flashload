...
async function main() {
  ...
  console.log("授权 1000 个kokoCoin和 1000 个acCoin给router");
  ...
  console.log(`首次添加ing......  添加 100 个kokoCoin 和 50 个acCoin， `);
  console.log(`后`);
  //开始添加流动性
  ...
  console.log(` 添加ing...... 添加 80 个kokoCoin 和 60 个acCoin, `);
  ...
  console.log(`前`);
  //owner swap 前拥有kokoCoin和acCoin的数量
